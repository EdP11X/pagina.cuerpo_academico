        ...
        <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
            ...
            <div class="hidden lg:flex lg:gap-x-12 flex-1 justify-center">
                @foreach(
                    ...
                    <a href="{{route($ruta)}}" class="text-sm/6 font-semibold text-white hover:text-gray-200 inline-flex items-center gap-2 hover:scale-120">
                        <i class="{{$icon}}"></i>
                        {{$label}}
                    </a>
                @endforeach
...
<footer class="bg-white dark:bg-gray-900">
    ...
    <div class="px-6 py-6 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
        <span class="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2025 <a href="https://flowbite.com/">Cuerpo Academico™</a>. All Rights Reserved.
        </span>
