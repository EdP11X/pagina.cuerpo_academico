...
<div class="bg-[#003B5C] py-16" data-aos="fade-down">
    <div class="mx-auto max-w-7xl px-6 lg:px-8 text-center">
        ...
        <div class="mt-8 flex justify-center gap-4" data-aos="fade-up" data-aos-delay="600">
            <a href="https://www.cs.buap.mx/OfertaAcademica.php" class="bg-white px-6 py-2 text-sm font-semibold text-[#003B5C]">Explorar Programas</a>
...
<div class="bg-gray-50 py-16">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="bg-white p-6 border" data-aos="fade-right" data-aos-delay="100">
            ...
            <div class="bg-white p-6 border" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="bg-white p-6 border" data-aos="fade-left" data-aos-delay="300">
        ...
        <div class="text-center mt-8" data-aos="fade-up" data-aos-delay="400">
            <a href="{{route('nosotros')}}" class="inline-block bg-[#003B5C] text-white px-6 py-2 text-sm font-semibold hover:bg-[#002B4C] transition-colors duration-300">Ver más </a>
        </div>
    </div>
</div>
...
<div class="bg-white py-16">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="p-6 border" data-aos="flip-left" data-aos-delay="100">
            ...
            <div class="p-6 border" data-aos="flip-left" data-aos-delay="200">
            ...
            <div class="p-6 border" data-aos="flip-left" data-aos-delay="300">
        ...
        <div class="text-center mt-8" data-aos="fade-up" data-aos-delay="400">
            <a href="{{route('nosotros')}}" class="inline-block bg-[#003B5C] text-white px-6 py-2 text-sm font-semibold hover:bg-[#002B4C] transition-colors duration-300">Ver más académicos</a>
        </div>
    </div>
</div>
...
<div class="bg-white py-16">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div class="text-center mt-8" data-aos="fade-up" data-aos-delay="400">
            <a href="{{route('eventos')}}" class="inline-block bg-[#003B5C] text-white px-6 py-2 text-sm font-semibold hover:bg-[#002B4C] transition-colors duration-300">Ver más eventos</a>
        </div>
    </div>
</div>
...
<div class="bg-gray-50 py-16">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="text-center mb-12" data-aos="fade-up">
            <h2 class="text-2xl font-bold text-[#003B5C] mb-4">Noticias y Actualizaciones</h2>
            <p class="text-gray-600">Mantente al día con nuestros últimos logros y actividades</p>
        </div>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
...
<div class="bg-white py-16">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div class="border rounded-lg overflow-hidden" data-aos="fade-right">
                <div class="p-6">
            ...
            <div class="border rounded-lg overflow-hidden" data-aos="fade-left">
                <div class="p-6">
        ...
        <div class="text-center mt-8" data-aos="fade-up" data-aos-delay="400">
            <a href="{{route('investigaciones')}}" class="inline-block bg-[#003B5C] text-white px-6 py-2 text-sm font-semibold hover:bg-[#002B4C] transition-colors duration-300">Ver más proyectos</a>
        </div>
    </div>
</div>
...
<div class="bg-gray-50 py-16">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div class="bg-white p-6 rounded-lg shadow-sm border" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="bg-white p-6 rounded-lg shadow-sm border" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="bg-white p-6 rounded-lg shadow-sm border" data-aos="fade-up" data-aos-delay="300">
...
<div class="bg-[#003B5C] py-12 text-center" data-aos="fade-up">
    ...
    <div class="flex justify-center gap-4">
        ...
        <a href="{{route('nosotros')}}" class="text-white text-sm font-semibold">Más información →</a>
    </div>
</div>
